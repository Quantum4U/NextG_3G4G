...
public class SIMDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mToolbar.setTitle("Phone Details");
        mToolbar.setTitleTextColor(Color.WHITE);

        context = SIMDetailsActivity.this;
...
//        private String[] text = context.getResources().getStringArray(R.array.root_array);
        ...
        private int[] icon = {R.drawable.version2_phone_detail,
                R.drawable.version2_phone_detail, R.drawable.version2_phone_detail, R.drawable.version2_phone_detail,
                R.drawable.version2_phone_detail, R.drawable.version2_phone_detail,
                R.drawable.version2_phone_detail, R.drawable.version2_phone_detail};
...
//            }
                ...
                if (position == 2) {
                    ...
                    View v = new AHandler().showNativeMedium(SIMDetailsActivity.this);
                    ...
                    appholder.icon.setImageDrawable(getResources()
