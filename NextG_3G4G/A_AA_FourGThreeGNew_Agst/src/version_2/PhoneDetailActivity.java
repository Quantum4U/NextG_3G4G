...
public class PhoneDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.version_root_fragment2);
        ...
        mToolbar.setTitle("Sim Details");
        mToolbar.setTitleTextColor(Color.WHITE);

        appSharedPreferences = new AppSharedPreferences(this);
        image = new ImageLoader(this);
        context = PhoneDetailActivity.this;
...
//        adsbanner.addView(new AHandler().getBannerHeader(getActivity()));
        ...
        checkmainblc = (LinearLayout) findViewById(R.id.checkbalance);

        checkdatablc = (LinearLayout) findViewById(R.id.checkdata);

        checkoffers = (LinearLayout) findViewById(R.id.ckeckbestoffer);

        checknumber = (LinearLayout) findViewById(R.id.checkmobnumber);

        checkmainblc.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                new AHandler().showFullAds(PhoneDetailActivity.this, false);
        ...
        checknumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AHandler().showFullAds(PhoneDetailActivity.this, false);
                System.out.println("here is the current provider"+" "+CURRENT_PROVIDER);
                if (CURRENT_PROVIDER == AIRTEL)
...
//        private String[] text = context.getResources().getStringArray(R.array.static_array);
        ...
        private int[] icon = {R.drawable.version2_simdetail,
                R.drawable.version2_simdetail, R.drawable.version2_simdetail, R.drawable.version2_simdetail,
                R.drawable.version2_simdetail};
...
//                }e
                ...
                if (position == 2) {
                    ...
                    appholder.nativeads.addView(new AHandler().showNativeMedium(PhoneDetailActivity.this));
...
//                    pre==text ; post==name
                    ...
                    appholder.icon.setImageDrawable(getResources().getDrawable(
                            this.icon[position]));
    ...
    public void init_Data() {
        ...
        System.out.println("inside operation "+" "+operator);
        if (operator.contains("airtel"))
            CURRENT_PROVIDER = AIRTEL;
        else if (operator.contains("!dea"))
    ...
    public void setUses() {
        int current = new UtilsApp().get_use_count(PhoneDetailActivity.this);
        int tempcount = current + 1;
        new UtilsApp().set_use_count(PhoneDetailActivity.this, tempcount);
