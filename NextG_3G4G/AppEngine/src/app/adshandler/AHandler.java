            ...
            try {
                if (getDaysDiff(context) >= getStringtoInt(Slave.TOP_BANNER_start_date)) {
                    if (Slave.TOP_BANNER_provider_id.equals(Slave.Provider_Admob_Banner)) {
                        ...
                        return new FbAdsProvider().getFBBanner(context, Slave.TOP_BANNER_ad_id);
                    }
...
//                }
                        ...
                        return getInhouseBanner(Slave.TOP_BANNER_src, Slave.TOP_BANNER_clicklink, context, InHouseAds.TYPE_NATIVE_SMALL);
                    } else if (Slave.TOP_BANNER_provider_id.equals(Slave.Provider_Startapp_Banner)) {
                        return getstartAppObj(context, Slave.TOP_BANNER_ad_id).getBannerAds(context);
                    } else if (Slave.TOP_BANNER_provider_id.equals(Slave.Provider_InMobi_BANNER)) {
                        return InMobiAdUtils.getInMobiObject().getInMobiBanner(context, Slave.TOP_BANNER_ad_id);
                    } else if (Slave.TOP_BANNER_provider_id.equals(Slave.Provider_Smaato_BANNER)) {
                        return SmaatoAdUtils.getSmaatoObj().getSmaatoBanner(context, Slave.TOP_BANNER_ad_id);
                    } else {
            ...
            try {
                if (getDaysDiff(context) >= getStringtoInt(Slave.BOTTOM_BANNER_start_date)) {
                    if (Slave.BOTTOM_BANNER_provider_id.equals(Slave.Provider_Admob_Banner)) {
                        ...
                        return new FbAdsProvider().getFBBanner(context, Slave.BOTTOM_BANNER_ad_id);
                    }
...
//                }
                        ...
                        return getInhouseBanner(Slave.BOTTOM_BANNER_src, Slave.BOTTOM_BANNER_clicklink, context, InHouseAds.TYPE_NATIVE_SMALL);
                    } else if (Slave.BOTTOM_BANNER_provider_id.equals(Slave.Provider_Startapp_Banner)) {
                        return getstartAppObj(context, Slave.TOP_BANNER_ad_id).getBannerAds(context);
...
//                        return adMobAds.admob_GetNativeMedium(context, Slave.NATIVE_MEDIUM_ad_id);
                            ...
                            return new AdmobNativeAdvanced().getNativeAdvancedAds(context, Slave.NATIVE_MEDIUM_ad_id, false);


                        } else if (Slave.NATIVE_MEDIUM_provider_id.equalsIgnoreCase(Slave.Provider_Facebook_Native_Medium)) {
                            //return new FbAdsProvider().getNativetemplate(context, Slave.NATIVE_MEDIUM_ad_id, 2, 0, 0, 0);
                            PrintLog.print("log check 1234 pos 2");
                            return new FbAdsProvider().getNativeAds(false, Slave.NATIVE_MEDIUM_ad_id, context, 0, 0, 0, 0, 0);
                        } else if (Slave.NATIVE_MEDIUM_provider_id.equals(Slave.Provider_Inhouse_Medium)) {
                            return getInhouseBanner(Slave.NATIVE_MEDIUM_src, Slave.NATIVE_MEDIUM_clicklink, context, InHouseAds.TYPE_NATIVE_MEDIUM);
                            ...
                            return InMobiAdUtils.getInMobiObject().getInMobiNative(context, false, Slave.NATIVE_MEDIUM_ad_id);

                        } else if (Slave.NATIVE_MEDIUM_provider_id.equals(Slave.Provider_Smaato_Native_Medium)) {
                            PrintLog.print("log check 1234 pos 4");
                            return SmaatoAdUtils.getSmaatoObj().getSmaatoMediumNative(context, Slave.NATIVE_MEDIUM_ad_id);
...
//                        return adMobAds.admob_GetNativeLarge(context, Slave.NATIVE_LARGE_ad_id);
                            ...
                            return new AdmobNativeAdvanced().getNativeAdvancedAds(context, Slave.NATIVE_LARGE_ad_id, true);
                        }


                        if (Slave.NATIVE_LARGE_provider_id.equalsIgnoreCase(Slave.Provider_Facebook_Native_Large)) {
                            return new FbAdsProvider().getNativeAds(true, Slave.NATIVE_LARGE_ad_id, context, 0, 0, 0, 0, 0);

                            //return new FbAdsProvider().getNativetemplate(context, Slave.NATIVE_MEDIUM_ad_id, 3, 0, 0, 0);
                        } else if (Slave.NATIVE_LARGE_provider_id.equals(Slave.Provider_Inhouse_Large)) {
                            return getInhouseBanner(Slave.NATIVE_LARGE_src, Slave.NATIVE_LARGE_clicklink, context, InHouseAds.TYPE_NATIVE_LARGE);
                            ...
                            return InMobiAdUtils.getInMobiObject().getInMobiNativeLarge(context, true, Slave.NATIVE_LARGE_ad_id);

                        } else if (Slave.NATIVE_LARGE_provider_id.equals(Slave.Provider_Smaato_Native_Large)) {
                            return SmaatoAdUtils.getSmaatoObj().getSmaatoLargeNative(context, Slave.NATIVE_LARGE_ad_id);
...
//                    return showNativesmall(context);
    ...
    public void showFullAds(Activity context, boolean is_force_ad) {
        ...
        if (!Slave.hasPurchased(context)) {
                ...
                if (getDaysDiff(context) >= getStringtoInt(Slave.FULL_ADS_start_date)) {
                    ...
                    if (Slave.FULL_ADS_provider_id.equals(Slave.Provider_Admob_FullAds)) {
                        ...
                        if (is_force_ad) {
                            ...
                            PrintLog.print("Full Ads Navigation COunt and is force is " + Slave.FULL_ADS_nevigation + " and " + is_force_ad);
                        ...
                        if (is_force_ad) {
                            ...
                            FbAdsProvider.getFbObject().loadFBFullAds(Slave.FULL_ADS_ad_id, context);
                            FbAdsProvider.getFbObject().showFBFullAds(Slave.FULL_ADS_ad_id, context);
                        ...
                        if (is_force_ad) {
                            ...
                            InMobiAdUtils.getInMobiObject().loadInMobiFullAds(context, Slave.FULL_ADS_ad_id);
                            InMobiAdUtils.getInMobiObject().showInMobiFullAds(context, Slave.FULL_ADS_ad_id);
                        ...
                        if (is_force_ad) {
                            ...
                            SmaatoAdUtils.getSmaatoObj().loadSmaatoFullAds(context, Slave.FULL_ADS_ad_id);
                            SmaatoAdUtils.getSmaatoObj().showSmaatoFullAds(context, Slave.FULL_ADS_ad_id);
            ...
            //Ads.printdata(" banner full  ads stage 11 "+DataHub.FULLADS_START_ID);
        }
    }
            ...
            if (getDaysDiff(context) >= getStringtoInt(Slave.LAUNCH_FULL_ADS_start_date)) {
                ...
                if (Slave.LAUNCH_FULL_ADS_provider_id.equals(Slave.Provider_Admob_FullAds)) {
                    ...
                    if (is_force_ad) {
                        ...
                        FbAdsProvider.getFbObject().loadFBFullAds(Slave.LAUNCH_FULL_ADS_ad_id, context);
                        FbAdsProvider.getFbObject().showFBFullAds(Slave.LAUNCH_FULL_ADS_ad_id, context);
                    ...
                    if (is_force_ad) {
                        ...
                        InMobiAdUtils.getInMobiObject().loadInMobiFullAds(context, Slave.LAUNCH_FULL_ADS_ad_id);
                        InMobiAdUtils.getInMobiObject().showInMobiFullAds(context, Slave.LAUNCH_FULL_ADS_ad_id);
                    ...
                    if (is_force_ad) {
                        ...
                        SmaatoAdUtils.getSmaatoObj().loadSmaatoFullAds(context, Slave.LAUNCH_FULL_ADS_ad_id);
                        SmaatoAdUtils.getSmaatoObj().showSmaatoFullAds(context, Slave.LAUNCH_FULL_ADS_ad_id);
            ...
            if (getDaysDiff(context) >= getStringtoInt(Slave.EXIT_FULL_ADS_start_date)) {
                ...
                if (Slave.EXIT_FULL_ADS_provider_id.equals(Slave.Provider_Admob_FullAds)) {
                    ...
                    if (is_force_ad) {
                        ...
                        FbAdsProvider.getFbObject().loadFBFullAds(Slave.EXIT_FULL_ADS_ad_id, context);
                        FbAdsProvider.getFbObject().showFBFullAds(Slave.EXIT_FULL_ADS_ad_id, context);
                    ...
                    if (is_force_ad) {
                        ...
                        InMobiAdUtils.getInMobiObject().loadInMobiFullAds(context, Slave.EXIT_FULL_ADS_ad_id);
                        InMobiAdUtils.getInMobiObject().showInMobiFullAds(context, Slave.EXIT_FULL_ADS_ad_id);
                    ...
                    if (is_force_ad) {
                        ...
                        SmaatoAdUtils.getSmaatoObj().loadSmaatoFullAds(context, Slave.EXIT_FULL_ADS_ad_id);
                        SmaatoAdUtils.getSmaatoObj().showSmaatoFullAds(context, Slave.EXIT_FULL_ADS_ad_id);
...
//                    if (is_force_ad) {
//
//                        FbAdsProvider.getFbObject().loadFBFullAds(DataHub.FULLADS_START_ID2, context);
//                        FbAdsProvider.getFbObject().showFBFullAds(DataHub.FULLADS_START_ID2, context);
//
//                    } else {
//
//                        if (getFullAdsCount(context) >= DataHub.FULLADS_NAV_COUNT2) {
...
//                    if (is_force_ad) {
//
//                        FbAdsProvider.getFbObject().loadFBFullAds(DataHub.FULLADS_START_ID3, context);
//                        FbAdsProvider.getFbObject().showFBFullAds(DataHub.FULLADS_START_ID3, context);
//
//                    } else {
//
//                        if (getFullAdsCount(context) >= DataHub.FULLADS_NAV_COUNT3) {
...
//    }
    ...
    public StartupAdsProvider getstartAppObj(Activity activity, String appid) {
...
//    }
    ...
    public void cacheFullPageAd(Activity context,OnCacheFullAdLoaded l) {
        if (!Slave.hasPurchased(context)) {
            try {
//            if (Slave.FULL_ADS_provider_id.equals(Slave.Provider_Admob_FullAds)) {
//                AdMobAds.getAdmobOBJ(context).admob_InitFullAds(context, Slave.FULL_ADS_ad_id, 90);
//
//            }
...
//            }
                ...
                if (Slave.LAUNCH_FULL_ADS_provider_id.equals(Slave.Provider_Admob_FullAds)) {
                    ...
                    // AdMobAds.getAdmobOBJ(context).admob_InitFullAds(context, Slave.LAUNCH_FULL_ADS_ad_id, 1);
...
//            if (Slave.EXIT_FULL_ADS_provider_id.equals(Slave.Provider_Admob_FullAds)) {
//                AdMobAds.getAdmobOBJ(context).admob_InitFullAds(context, Slave.EXIT_FULL_ADS_ad_id, 1);
//
//            }
...
//                }
    ...
    public void v2CallOnSplash(final Context context,OnCacheFullAdLoaded l) {
    ...
    public void v2CallonAppLaunch(Activity context) {
        if (!Slave.hasPurchased(context)) {
