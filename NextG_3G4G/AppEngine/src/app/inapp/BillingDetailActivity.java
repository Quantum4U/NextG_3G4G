...
public class BillingDetailActivity extends AppCompatActivity {
    ...
    private ImageView detail_src;
    private TextView btn_text, btn_subtext, header;
    private LinearLayout layoutPurchase, details_description;
//    private InAppHandler mHandler;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        layoutPurchase = (LinearLayout) findViewById(R.id.layoutPurchase);
        ...
        detail_src = (ImageView) findViewById(R.id.details_src);
        details_description = (LinearLayout) findViewById(R.id.details_description);

        btn_text = (TextView) findViewById(R.id.btn_text);
        btn_subtext = (TextView) findViewById(R.id.btn_subtext);
...
//            details_description.setText(b.details_description);
            ...
            if (b.details_src != null && !b.details_src.equalsIgnoreCase("")) {
                Picasso.with(this).load(b.details_src).into(detail_src);
            }
...
//                            mOnInitListener.onPurchaseFinishedListener(mSubscribedToYearly);
    ...
    private void showPurchaseDialog() {
        ...
        LinearLayout restartLater = (LinearLayout) dialog.findViewById(R.id.restartLater);
        LinearLayout restartNow = (LinearLayout) dialog.findViewById(R.id.restartNow);
