...
public class ANG_StartupAdsProvider {
    ...
    public ANG_StartupAdsProvider(Activity activity, String appid) {
        appid = appid.trim();
...
//        bannerParameters.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
        ...
        startAppBanner.setBannerListener(new BannerListener() {
            ...
            public void onReceiveAd(View view) {
                PrintLog.print("ANG_StartupAdsProvider.onReceiveAd ");
            ...
            public void onFailedToReceiveAd(View view) {
                ...
                PrintLog.print("ANG_StartupAdsProvider.onFailedToReceiveAd ");
            }

            @Override
            public void onClick(View view) {
                PrintLog.print("ANG_StartupAdsProvider.onClick ");
        ...
        startAppNativeAd.loadAd(
                ...
                new AdEventListener() {
                    ...
                    public void onReceiveAd(Ad ad) {
                        ...
                        LinearLayout adView = (LinearLayout) inflater.inflate(R.layout.ang_sa_native_medium,
                                null, false);
        ...
        startAppNativeAd.loadAd(
                ...
                new AdEventListener() {
                    ...
                    public void onReceiveAd(Ad ad) {
                        PrintLog.print("0956 checking 01");
                        LayoutInflater inflater = LayoutInflater.from(context);
                        LinearLayout adView = (LinearLayout) inflater.inflate(R.layout.ang_sa_native_large,
                                null, false);
