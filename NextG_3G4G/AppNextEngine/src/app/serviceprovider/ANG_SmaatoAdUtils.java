...
public class ANG_SmaatoAdUtils {
    LinearLayout adView;
    ...
    static ANG_SmaatoAdUtils smaatoAdUtils = null;
    String publisherID;
    String adspaceID;
    String stringIDS;
    ...
    public View getSmaatoBanner(final Activity ctx, String id) {
        ...
        try {
            ...
            PrintLog.print("1401 ANG_SmaatoAdUtils catch banner admob");
        }
        ...
        mBannerAd.addAdListener(new AdListenerInterface() {
            ...
            public void onReceiveAd(AdDownloaderInterface adDownloaderInterface, ReceivedBannerInterface receivedBanner) {
                if (receivedBanner.getStatus() == BannerStatus.SUCCESS) {
                    ...
                    PrintLog.print("1401 ANG_SmaatoAdUtils banner loaded");
...
//                    Toast.makeText(ctx,receivedBanner.getErrorMessage(),Toast.LENGTH_LONG).show();
                    if (adMobAds == null)
                        adMobAds = new ANG_AdMobAds(ctx);
                    adsviewBannerlocal.addView(adMobAds.admob_GetBannerAds(ctx, Slave.ADMOB_BANNER_ID_STATIC));
                    PrintLog.print("1401 ANG_SmaatoAdUtils banner ads " + receivedBanner.getErrorMessage());
    ...
    public View getSmaatoLargeNative(final Activity ctx, String id) {
        ...
        try {
            adView = (LinearLayout) inflater.inflate(R.layout.ang_smaato_native_large_ads,
            ...
            if (mContainer != null && mContainer.getChildCount() > 0) {
                ...
                PrintLog.print("ANG_SmaatoAdUtils.getSmaatoNative");
            }
            ...
            if (adMobAds == null)
                adMobAds = new ANG_AdMobAds(ctx);
            adsviewlocalLarge.addView(new ANG_AdmobNativeAdv().getNativeAdvancedAds((Activity) ctx,
                    Slave.ADMOB_NATIVE_LARGE_ID_STATIC, true));
            PrintLog.print("1401 ANG_SmaatoAdUtils LargeNative catch admob");
        }
        ...
        nativeAdLarge.setAdListener(new AdListenerInterface() {
            ...
            public void onReceiveAd(AdDownloaderInterface adDownloaderInterface, ReceivedBannerInterface receivedBanner) {
                if (receivedBanner.getStatus() == BannerStatus.SUCCESS) {
                    ...
                    PrintLog.print("1401 ANG_SmaatoAdUtils LargeNative ads loaded");
                    ...
                    adsviewlocalLarge.addView(new ANG_AdmobNativeAdv().getNativeAdvancedAds((Activity) ctx,
                            Slave.ADMOB_NATIVE_LARGE_ID_STATIC, true));
                    PrintLog.print("1401 ANG_SmaatoAdUtils LargeNative ads " + receivedBanner.getErrorMessage());
                }
            }
        });
    ...
    public View getSmaatoMediumNative(final Activity ctx, String id) {
        ...
        try {
            adView = (LinearLayout) inflater.inflate(R.layout.ang_smaato_native_medium_ads,
            ...
            if (adMobAds == null)
                adMobAds = new ANG_AdMobAds(ctx);
            adsviewlocalMedium.addView(new ANG_AdmobNativeAdv().getNativeAdvancedAds((Activity) ctx,
                    Slave.ADMOB_NATIVE_LARGE_ID_STATIC, false));
            PrintLog.print("1401 ANG_SmaatoAdUtils MediumNative catch admob");
        }
        ...
        nativeAdMedium.asyncLoadNativeType(NativeAd.NativeType.NEWS_FEED, new NativeAd.NativeAdTypeListener() {
            ...
            public void onError(ErrorCode errorCode, String errorMessage) {
                ...
                if (errorMessage != null) {
                    ...
                    adsviewlocalMedium.addView(new ANG_AdmobNativeAdv().getNativeAdvancedAds((Activity) ctx,
                            Slave.ADMOB_NATIVE_LARGE_ID_STATIC, false));
                    PrintLog.print("1401 ANG_SmaatoAdUtils MediumNative OnErrorResponse" + errorCode + " " + errorMessage);
                }
            ...
            public void onAdResponse(ViewGroup nativeView) {
                if (nativeView != null) {
                    PrintLog.print("1401 ANG_SmaatoAdUtils MediumNative Generated RelativeLayout (NEWS_FEED) view received");
        ...
        nativeAdMedium.setAdListener(new AdListenerInterface() {
            ...
            public void onReceiveAd(AdDownloaderInterface adDownloaderInterface, ReceivedBannerInterface receivedBanner) {
                ...
                if (receivedBanner.getStatus() == BannerStatus.SUCCESS) {
                    // adsviewlocal.addView(adView);
                    PrintLog.print("1401 ANG_SmaatoAdUtils MediumNative ads loaded");
                    ...
                    adsviewlocalMedium.addView(new ANG_AdmobNativeAdv().getNativeAdvancedAds((Activity) ctx,
                            Slave.ADMOB_NATIVE_LARGE_ID_STATIC, false));
                    PrintLog.print("1401 ANG_SmaatoAdUtils MediumNative ads " + receivedBanner.getErrorMessage());
                }
    ...
    public void loadSmaatoFullAds(final Activity activity, String id) {
        ...
        try {
            ...
            PrintLog.print("1401 ANG_SmaatoAdUtils fullads catch admob");
        }

        mInterstitialAd.setInterstitialAdListener(new InterstitialAdListener() {
            @Override
            public void onReadyToShow() {
                PrintLog.print("1401 ANG_SmaatoAdUtils full ads loaded ");
            }
            ...
            public void onFailedToLoadAd() {
                // Toast.makeText(activity,"Full ANG_Ads Failed",Toast.LENGTH_LONG).show();
                PrintLog.print("1401 ANG_SmaatoAdUtils full ads failed ");
    ...
    public void showSmaatoFullAds(Activity activity, String id) {
        ...
        if (mInterstitialAd != null && mInterstitialAd.isInterstitialReady()) {
            ...
            PrintLog.print("1401 ANG_SmaatoAdUtils full show ");
        } else {
            if (adMobAds == null)
                adMobAds = new ANG_AdMobAds(activity);
            adMobAds.admob_showFullAds(activity, Slave.ADMOB_FULL_ID_STATIC);
    ...
    public static ANG_SmaatoAdUtils getSmaatoObj() {
        if (smaatoAdUtils == null)
            smaatoAdUtils = new ANG_SmaatoAdUtils();
