                ...
                if (response != null && !response.equalsIgnoreCase(DataHubConstant.KEY_NA)) {
                    ...
                    if (hubResponse != null && hubResponse.message.equalsIgnoreCase(DataHubConstant.KEY_SUCESS)) {
                        ...
                        if (hubResponse.adsresponse != null && hubResponse.adsresponse.size() > 0) {
                            ...
                            if (adsResponses != null && adsResponses.size() > 0) {
                              ...
                              /*  BillingHandler b = new BillingHandler(context, new InAppHandler.onInitializeListener() {
                                    @Override
 ...
 */
    ...
    public void parseDecryptReferalData(Context context, String response) {
    ...
    private void loadSlaveAdResponse(List<AdsResponse> list) {
        if (list != null && list.size() > 0) {
            PrintLog.print("0555 checking loadSlaveAdResponse");
            for (int i = 0; i < list.size(); i++) {
                if (list.get(i).type.equalsIgnoreCase(Slave.TYPE_TOP_BANNER)) {
                    PrintLog.print("0555 checking Type Top Banner");
                    PrintLog.print(" Enginev2 Parging tag Slave.TYPE_TOP_BANNER value is " + list.get(i));
                    ...
                    PrintLog.print("0555 checking Type Bottom Banner");
                    PrintLog.print(" Enginev2 Parging tag Slave.TYPE_BOTTOM_BANNER value is " + list.get(i));
                    ...
                    PrintLog.print(" Enginev2 Parging tag Slave.TYPE_LAUNCH_FULL_ADS value is " + list.get(i));
                    ...
                    PrintLog.print(" Enginev2 Parging tag Slave.TYPE_NATIVE_MEDIUM value is " + list.get(i));
